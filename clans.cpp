...
Clans::Clans(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Clans)
{
    ui->setupUi(this);
    QScroller::grabGesture(ui->bane->viewport(),QScroller::LeftMouseButtonGesture);
    QScroller::grabGesture(ui->desc->viewport(),QScroller::LeftMouseButtonGesture);
    QScroller::grabGesture(ui->compulsion->viewport(),QScroller::LeftMouseButtonGesture);
    ui->picture->setMaximumWidth(this->width()/3);
    ui->picture->setMaximumHeight(this->width()/3);
    ui->picture->pixmap().scaled(this->width()/3, this->width()/3, Qt::KeepAspectRatio, Qt::SmoothTransformation);
...
void Clans::on_comboBox_currentIndexChanged(int index)
{
    ui->discplineList->setText(tr("Disciplines:\n"));
    if(ui->comboBox->currentText() == "Banu Haqim"){
    ...
    else if(ui->comboBox->currentText() == "Brujah"){
    ...
    else if(ui->comboBox->currentText() == "Thin-Blood"){
    ...
    else if(ui->comboBox->currentText() == "Gangrel"){
    ...
    else if(ui->comboBox->currentText() == "Hecata"){
    ...
    else if(ui->comboBox->currentText() == "Lasombra"){
    ...
    else if(ui->comboBox->currentText() == "Malkavian"){
    ...
    else if(ui->comboBox->currentText() == "Ministry"){
    ...
    else if(ui->comboBox->currentText() == "Nosferatu"){
    ...
    else if(ui->comboBox->currentText() == "Caitiff"){
        ui->nicknames->setText(tr("The Clanless, The Wretched, Freestylers,  Orphans, Trash, Unbound (endonym), Parias"));
    ...
    else if(ui->comboBox->currentText() == "Ravnos"){
    ...
    else if(ui->comboBox->currentText() == "Salubri"){
    ...
    else if(ui->comboBox->currentText() == "Toreador"){
    ...
    else if(ui->comboBox->currentText() == "Tremere"){
    ...
    else if(ui->comboBox->currentText() == "Tzimisce"){
    ...
    else if(ui->comboBox->currentText() == "Ventrue"){
    ...
    pic.load(":/images/clans/" + ui->comboBox->currentText() + ".png");
    ui->label->setText(ui->comboBox->itemText(index));
    ui->picture->updateGeometry();
    ui->picture->setPixmap(pic);
}


void Clans::on_checkBox_clicked()
{
